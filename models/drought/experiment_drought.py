...
def run_experiment():
    ...
    try:
        ...
        print("  v2: Added XGBoost + SPI features")
        print("=" * 60)

        # 1. Load Data (now includes SPI-3, SPI-6, consecutive_dry_months)
        ...
        # 5b. Feature Importance (for tree-based winners)
        ...
        if importances is not None:
            ...
            plt.tight_layout()
            plt.savefig(os.path.join(plots_dir, "drought_feature_importance.png"))
            plt.close()
        ...
        with open(exp_report_path, "w") as f:
            f.write("# Experiment Report: Drought Prediction (v2)\n\n")
            ...
            f.write("**v2 upgrade:** Added SPI-3/SPI-6 (Standardized Precipitation Index via gamma distribution), ")
            f.write("consecutive dry months feature, and XGBoost as a candidate model.\n\n")

            f.write("## 2. Methodology\n")
            f.write("- **Data Source:** IMD Rainfall Records (121 years, 1901-2021).\n")
            f.write("- **Features:** 3/6 month rolling averages, rainfall deficit %, previous year drought,\n")
            f.write("  monsoon strength, SPI-3, SPI-6, consecutive dry months.\n")
            f.write("- **Models:** Ridge, SVR, Random Forest, XGBoost.\n\n")
            ...
            if importances is not None:
                ...
                f.write("![Feature Importance](/static/plots/drought_feature_importance.png)\n\n")
